    ...
    <div class="container h-100 d-flex flex-column">
        <div class="row align-items-stretch no-gutters px-screen-mob">
            <div class="position-relative">
                ...
                <div class="offcanvas offcanvas-end h-100vh" tabindex="-1" id="offcanvasCases" aria-labelledby="offcanvasCasesLabel">
                    <div class="sticky-top top-0 w-100 bg-blue d-flex justify-content-between align-items-center p-2">
